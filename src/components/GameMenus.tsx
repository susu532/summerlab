...
const ShopUI = lazy(() =>
  import("./ShopUI").then((m) => ({ default: m.ShopUI })),
);
...
const ServerJoinUI = lazy(() =>
  import("./ServerJoinUI").then((m) => ({ default: m.ServerJoinUI })),
);
const LaunchMenuUI = lazy(() =>
  import("./LaunchMenuUI").then((m) => ({ default: m.LaunchMenuUI })),
);
            ...
            onDropItem={(type: any, count: number) => {
              if (
                ...
                useGameStore
                  .getState()
                  .addMessage(
                    "You cannot drop your role's essential tool!",
                    "#FF5555",
                  );
              ...
              const dropPos = game.player.playerHeadPos
                .clone()
          ...
          {isServerJoinOpen && (
            <ServerJoinUI
              ...
              onJoin={() => {
                ...
                setCurrentNPC(null);
                networkManager
                  .initMatchmaking(targetServer)
                  .then(() => {
                    typeof setGameKey === "function" &&
